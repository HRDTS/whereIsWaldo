         ...
         <header className="homePageHeader2">
            ...
            <div className="scoreboardButtonDiv">
             ...
             <div className="soreboardGrid">
                <img className="scoreboardGridItem" src={PokeMap} onClick={() => setSelectedMap(0)} style={selectedMap == 0 ? {border: "10px solid limegreen"} : null}/>
                <img className="scoreboardGridItem" src={PokeMap} onClick={() => setSelectedMap(1)} style={selectedMap == 1 ? {border: "10px solid limegreen"} : null}/>
                <img className="scoreboardGridItem" src={PokeMap} onClick={() => setSelectedMap(2)} style={selectedMap == 2 ? {border: "10px solid limegreen"} : null}/>
             </div>
